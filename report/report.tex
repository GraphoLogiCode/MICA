...
\title{MICA: Measuring Whether an AI Can Understand a Minecraft Builder's\\
...
The system is named \textbf{MICA} --- \emph{Minecraft Intention-Aware
Collaborative Agent}. The name records the design goal, not a result: whether
the agent has \emph{earned} the word ``collaborative'' is precisely what this
apparatus exists to measure, and as \S\ref{sec:failed} reports, it has not
yet --- by its own pinned admission, it has never placed a block.
